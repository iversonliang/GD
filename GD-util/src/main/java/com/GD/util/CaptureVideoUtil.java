...
public class CaptureVideoUtil {
	...
	public static CaptureVideo getYouKuCaptureVideo(String url) throws Exception {
		...
		return CaptureVideoUtil.getYouKuCaptureVideoById(videoId, url);
	}

	public static CaptureVideo getYouKuCaptureVideoById(String videoId, String url) throws Exception {
	...
	public static void main(String[] args) throws Exception {
		// CaptureVideo video =
		// CaptureVideoUtil.getYouKuCaptureVideo("http://v.youku.com/v_show/id_XNTA1MzI1NDQ4.html");
